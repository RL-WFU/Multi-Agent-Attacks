...
from maddpg_implementation.maddpg.common.distributions import make_pdtype
from maddpg_implementation.maddpg import AgentTrainer
from maddpg_implementation.maddpg.trainer.replay_buffer_1 import ReplayBuffer
...
class MADDPGAgentTrainer(AgentTrainer):
    def __init__(self, name, model, obs_shape_n, act_space_n, agent_index, args, local_q_func=False):
        ...
        #print(np.asarray(obs_shape_n).shape)
    ...
    def update(self, agents, t):
        ...
        #print((np.asarray(obs_n)).shape)
        #print((np.asarray(act_n)).shape) #This should be (1024, 5) It seems like act is the action, rather than the probs
        #print((np.asarray([target_q])).shape)
